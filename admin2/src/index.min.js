...
var MainPage = {
  ...
  beforeCreate: function beforeCreate() {
    ...
    // fetchData(){
    var baseURI = 'api/cousel.data.php';
  ...
  methods: {
    ...
    ViewData: function ViewData(datas) {
      // eventBus.$emit('propsId',datas)
      location.href = "main.html#/view/".concat(datas);
    }
  }
};
var CousulView = {
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      axios.post("".concat(baseURI), {
        ...
        _this3.loading = true;
        _this3.post = result.data.result[0];
      }).catch(function (err) {
        return console.log('Login: ', err);
      });
    }
