  ...
  WorkDataRender: function WorkDataRender(page) {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        var MoreBtn = document.querySelectorAll('.more_tag'); // for (let i = 5; i < MoreBtn.length; i++) {
        //     MoreBtn[i].classList = ""
        // }

        for (var _i2 = limitList; _i2 < WorkList.length; _i2++) {
          WorkList[_i2].style.display = "none";
        }
      }
    };
